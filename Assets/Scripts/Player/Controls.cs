...
#region MyPrivateMethods
    ...
    public void UpdateStats()
    {
        ...
        if (_jumpForce + _currentMoveMult * 0.384615f <= 2)
        {
            jumpForce = 2;
        }
        else
        ...
        if (_crouchSpeed + _currentMoveMult * 0.692308f <= 1)
        {
            crouchSpeed = 1;
        }
        else
        ...
        if (_walkSpeed + _currentMoveMult <= 2)
        {
            walkSpeed = 2;
        }
        else
        ...
        if (_sprintSpeed + _currentMoveMult<=3)
        {
            sprintSpeed = 3;
        }
        else

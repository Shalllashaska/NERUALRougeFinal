...
public class WeaponManager : MonoBehaviour
{
    ...
    private AudioClip _currentShotClip;
    private AudioClip _currentReloadClip;
    ...
    private void Awake()
    {
        ...
        loadout[0] = PlayerSettings.weapon1;
        if (PlayerSettings.weapon2 != null)
        {
            loadout[1] = PlayerSettings.weapon2;
        }
    ...
    {
        _weaponResourcesHolders[_currentInd].SetStash(_weaponResourcesHolders[_currentInd].GetStash()+ammo);
    }
    ...
    public void Equip(int ind)
    {
        ...
        weaponSFX.Stop();
        weaponSFX.PlayOneShot(switchSound);
        ...
        _currentShotClip = _currentGunData.gunShotSound;
        _currentReloadClip = _currentGunData.reloadSound;
        if (player != null)
        {
            UpdateStats();
        }
    ...
    {
        weaponSFX.clip = _currentReloadClip;
        weaponSFX.pitch = 1;
        weaponSFX.Play();
    }
    ...
    {
        weaponSFX.clip = _currentShotClip;
        weaponSFX.pitch = Random.Range(0.9f, 1.1f);
        weaponSFX.PlayOneShot(weaponSFX.clip);
    }
